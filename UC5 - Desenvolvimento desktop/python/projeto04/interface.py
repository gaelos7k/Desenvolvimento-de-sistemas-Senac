...
class LibraryApp(ctk.CTk):
    ...
    def show_main_menu(self):
        ...
        # Cards
        card_data = [
            {"icon": "👤", "title": "Leitores", "button": "Gerenciar leitores", "command": self.show_leitor_menu},
            {"icon": "📖", "title": "Livros", "button": "Gerenciar livros", "command": self.show_livro_menu},
            {"icon": "🔍", "title": "Empréstimos", "button": "Gerenciar empréstimos", "command": self.show_emprestimo_menu},
            {"icon": "🚪", "title": "Sair", "button": "Sair do aplicativo", "command": self.quit},
        ]
        ...
        for i, data in enumerate(card_data):
            ...
            # Ícone circular
            icon_frame = ctk.CTkFrame(card, fg_color="#b39ddb", width=100, height=100, corner_radius=50)
            icon_frame.pack(pady=(40, 20))
            icon_frame.pack_propagate(False)
            
            icon = ctk.CTkLabel(icon_frame, text=data["icon"], font=("Arial", 45))
    ...
    def cadastrar_leitor(self):
        ...
        ctk.CTkLabel(dialog, text="Código do leitor:", font=("Arial", 14)).pack(pady=5)
        cod_entry = ctk.CTkEntry(dialog, width=300, height=35)
        cod_entry.pack(pady=5)
        
        ctk.CTkLabel(dialog, text="Nome do leitor:", font=("Arial", 14)).pack(pady=5)
        nome_entry = ctk.CTkEntry(dialog, width=300, height=35)
        nome_entry.pack(pady=5)
        
        ctk.CTkLabel(dialog, text="Telefone do leitor:", font=("Arial", 14)).pack(pady=5)
        telefone_entry = ctk.CTkEntry(dialog, width=300, height=35)
        telefone_entry.pack(pady=5)
        
        def salvar():
            leitor = Leitor(cod_entry.get(), nome_entry.get(), telefone_entry.get())
    ...
    def atualizar_leitor(self):
        ...
        ctk.CTkLabel(dialog, text="Novo nome:", font=("Arial", 14)).pack(pady=5)
        nome_entry = ctk.CTkEntry(dialog, width=300, height=35)
        nome_entry.pack(pady=5)
        
        ctk.CTkLabel(dialog, text="Novo telefone:", font=("Arial", 14)).pack(pady=5)
        telefone_entry = ctk.CTkEntry(dialog, width=300, height=35)
        telefone_entry.pack(pady=5)
        
        def atualizar():
            Leitor.atualizar_leitor(Leitor, cod_entry.get(), nome_entry.get(), telefone_entry.get())
        ...
        def consultar():
            for leitor in Leitor.leitores:
                if leitor.cod == cod_entry.get():
                    resultado_label.configure(text=f"Código: {leitor.cod}\nNome: {leitor.nome}\nTelefone: {leitor.telefone}")
                    return
    ...
    def cadastrar_livro(self):
        ...
        ctk.CTkLabel(dialog, text="Quantidade de exemplares:", font=("Arial", 14)).pack(pady=5)
    ...
    def atualizar_livro(self):
        ...
        ctk.CTkLabel(dialog, text="Novo título:", font=("Arial", 14)).pack(pady=5)
        titulo_entry = ctk.CTkEntry(dialog, width=300, height=35)
        titulo_entry.pack(pady=5)
        
        ctk.CTkLabel(dialog, text="Novos autores:", font=("Arial", 14)).pack(pady=5)
        autores_entry = ctk.CTkEntry(dialog, width=300, height=35)
        autores_entry.pack(pady=5)
        
        ctk.CTkLabel(dialog, text="Nova edição:", font=("Arial", 14)).pack(pady=5)
        edicao_entry = ctk.CTkEntry(dialog, width=300, height=35)
        edicao_entry.pack(pady=5)
        
        ctk.CTkLabel(dialog, text="Nova quantidade:", font=("Arial", 14)).pack(pady=5)
        qtd_entry = ctk.CTkEntry(dialog, width=300, height=35)
        qtd_entry.pack(pady=5)
    ...
    def registrar_emprestimo(self):
        ...
        ctk.CTkLabel(dialog, text="ISBN do livro:", font=("Arial", 14)).pack(pady=5)
        isbn_entry = ctk.CTkEntry(dialog, width=300, height=35)
        isbn_entry.pack(pady=5)
