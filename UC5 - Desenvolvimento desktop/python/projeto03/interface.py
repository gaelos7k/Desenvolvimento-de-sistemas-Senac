...
class AplicativoTarefas:
    ...
    def criar_interface(self):
        ...
        self.frame_menu = ctk.CTkFrame(self.frame_principal, fg_color="#36558F", corner_radius=15)
        self.frame_menu.pack(side="left", fill="y", padx=(0, 20), pady=0, ipadx=20, ipady=20)
        ...
        self.frame_conteudo = ctk.CTkFrame(self.frame_principal, fg_color="#B8CDE8", corner_radius=15)
    ...
    def adicionar_tarefa(self):
        ...
        if descricao:
            ...
            self.texto_tarefas.insert("1.0", f"✅ Tarefa '{descricao}' adicionada com sucesso!\n")
    ...
    def concluir_tarefa(self):
        ...
        if descricao:
            ...
            self.texto_tarefas.delete("1.0", "end")
            self.texto_tarefas.insert("1.0", f"✅ Tarefa '{descricao}' marcada como concluída!\n")
    ...
    def listar_todas_tarefas(self):
        ...
        if not self.lista_tarefas.tarefas:
            ...
            for i, tarefa in enumerate(self.lista_tarefas.tarefas, 1):
                ...
                cor_status = "🟢" if tarefa.concluida else "🔴"
                self.texto_tarefas.insert(
                    "end",
                    f"{i}. {status_icon} {tarefa.descricao}\n   {cor_status} Status: {status_text}\n\n"
                )
    ...
    def salvar_arquivo(self):
        ...
        messagebox.showinfo("Sucesso", "Tarefas salvas no arquivo com sucesso!")
